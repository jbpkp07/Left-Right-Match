...
function printHeader() {
    ...
    terminal_kit_1.terminal.brightBlue(" │").brightCyan("                              Left-Right-Match                               ").brightBlue("│\n");
    terminal_kit_1.terminal.brightBlue(" │").brightCyan("                                    v1.0                                     ").brightBlue("│\n");
    terminal_kit_1.terminal.brightBlue(" │").brightCyan("         written by: Danielle Fernandez, Jeremy Barnes, William Hurst        ").brightBlue("│\n");
    terminal_kit_1.terminal.brightBlue(" ├─────────────────────────────────────────────────────────────────────────────┤\n");
    ...
    terminal_kit_1.terminal.brightBlue(" │                                                                             │\n");
    terminal_kit_1.terminal.brightBlue(" │").brightCyan(" Description : ").gray("Welcome to Left-Right-Match, a MERN webapp!").brightBlue("                   │\n");
